...
module.exports = {
  ...
  "_spec": "axios@^0.21.4",
  "_where": "/Users/ga-rra-pa-te-ro/Documents/A-I/coding/lemoncode/bootcamp-js/ejercicios-bootcamp-js/00",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-iban-validator":"../node_modules/@lemoncode/fonk-iban-validator/dist/@lemoncode/fonk-iban-validator.esm.js","@lemoncode/fonk-positive-number-validator":"../node_modules/@lemoncode/fonk-positive-number-validator/dist/@lemoncode/fonk-positive-number-validator.esm.js","./transfer.custom.validator":"pages/transfer/transfer.custom.validator.js"}],"core/router/routes.js":[function(require,module,exports) {
"use strict";
...
(0, _accountList.getAccountList)(params.id).then(function (accountList) {
...
(0, _helpers.onSubmitForm)('transfer-button', function () {
  ...
  _transfer3.formValidation.validateForm(transfer).then(function (result) {
    ...
    if (result.succeeded) {
      (0, _transfer.sendTransfer)(transfer).then(function () {
        _router.history.push(_router.routes.accountList);
      });
    }
  });
});
},{"../account-list/account-list.api":"pages/account-list/account-list.api.js","./transfer.api":"pages/transfer/transfer.api.js","../../common/helpers":"common/helpers/index.js","./transfer.helpers/":"pages/transfer/transfer.helpers.js","./transfer.validations":"pages/transfer/transfer.validations.js","../../core/router":"core/router/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
